...
public class SettingsFragment extends Fragment {
    ...
    private void saveAndExit() {
        ...
        requireContext().getSharedPreferences(StopwatchFragment.PREFERENCES_NAME, Context.MODE_PRIVATE)
                .edit().putBoolean(StopwatchFragment.MILLIS_PREFERENCE, showMillis).apply();
