...
public class StopwatchService extends Service {
    ...
    static long sFromStartTime = 0, sStartTime = -1, sUntilStartTime = 0;
    ...
    public void onCreate() {
        super.onCreate();
        mShowPagePendingIntent = Utils.createShowPagePendingIntent(StopwatchRoot.STRING_ID, getApplicationContext());
    }
    ...
    public void updateNotification(Long time) {
        ...
        NotificationCompat.Builder timeNotification = new NotificationCompat.Builder(getApplicationContext(), StopwatchRoot.NOTIFICATION_CHANNEL_ID)
    ...
    private void sendTime(long time) {
        // send to gui
        Intent uiIntent = new Intent(StopwatchHome.ACTION_UPDATE_VIEW).setPackage(getPackageName());
        uiIntent.putExtra(StopwatchHome.ELAPSED_TIME_EXTRA, time);
