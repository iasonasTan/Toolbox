...
public final class BroadcastSenderService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (Objects.requireNonNull(intent.getAction())) {
            case ACTION_STOP -> serviceIntent.setAction(StopwatchService.ACTION_STOP_TIMER);
            case ACTION_START -> serviceIntent.setAction(StopwatchService.ACTION_START_TIMER);
            case ACTION_RESET -> serviceIntent.setAction(StopwatchService.ACTION_RESET_TIMER);
